...
#             print('output_error.shape', output_error.shape)
            ...
            hidden_error = (np.dot(self.weights_hidden_to_output, output_error)).T
...
test_w_i_h = np.array([[0.1, -0.2],
                       [0.4, 0.5],
                       [-0.3, 0.2]])
# print('test_w_i_h.shape', test_w_i_h.shape)
test_w_h_o = np.array([[0.3],
                       [-0.1]])
# print('test_w_h_o.shape', test_w_h_o.shape)
...
#         print('h2o', network.weights_hidden_to_output)
#         print('i2h', network.weights_input_to_hidden)
...
# From the above experiments, the Data fits pretty well for the first half of the testing set. But from Dec 21 - Dec 31, while the value of data goes down (Christmas), the model can still works out the trend but the error is high especially during Dec 24-26. But generally, the training has been working well and I've learned a lot about machine learning, particularly backpropagation after resuming the learning process in the summer. But one point I can't understand well is that the training loss is smaller than the validation loss. Could you clear up this for me? 
# Y-Chen from January Class
# 
# iterations = 10000, 
# learning_rate = 0.2
# hidden_nodes = 5
